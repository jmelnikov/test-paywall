Привет! Спасибо за ожидание, действительно, дел иногда (как на этой неделе) больше чем я могу осилить.
Для чего мне и нужен ещё один умный коллега, с которым мы в итоге будем выполнять больше задач, а работать только в комфортной нагрузке.

Для задания нужно написать код с нуля. Конечно, всегда есть куда улучшать до бесконечности, но для оптимального обсуждения стоит ориентироваться на примерно 4 часа работы.
...
Я в любом случае готов на созвон, но мне нужно будет время на изучение кода перед ним. Поэтому мы можем назначать дату и время созвона уже сейчас если понятно когда тестовое будет готово, главное иметь код решения за 3-4 часа до него.
